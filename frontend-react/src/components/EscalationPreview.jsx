...
export default function EscalationPreview({ escalation, onMarkResolved, onClose }) {
  return (
      ...
      <div className="escalation-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="escalation-section">
          ...
          <div className="info-grid">
            ...
            <div className="info-item">
              ...
              <span className="value">₹{escalation.risk_score?.toFixed(0) || '—'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="escalation-section">
          ...
          <div className="issue-summary">
            <p>
              This {escalation.failure_type} has been <strong>overdue for {escalation.hours_overdue?.toFixed(1)}  hours</strong>.
            </p>
            <p className="mt-1">
              The system's agents have attempted standard resolution procedures, but cannot proceed without human judgment.
            </p>
          </div>
        </div>
        ...
        <div className="escalation-section">
          ...
          <div className="action-options">
            <div className="action-card">
              ...
              <div className="risk-note">⚠️ Bypasses standard approval chain</div>
            </div>
            <div className="action-card">
